...
// 2) crie uma função que receba um número e devolva uma soma progressiva. Por exemplo, 
...
let texto = ""
do {
    texto = input.question("DIgite algo ou thau para sair: ")
    console.log(`Voce digitou: ${texto}`)    
}while (texto != 'thau')

console.log(`Thau, ${nome}!`)
} 
imprimeComandos()
...
// Exemplo, recebendo 15 o resultado será 1 2 banana 4 biscoito banana 7 8 banana biscoito 11 banana 13 14
// biscoito de banana
